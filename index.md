...
10. Verifique que las instalaciones se hayan realizado correctamente dando click en el botón **play** (▶️), puede encontrarlo en la parte superior del editor, justo en el centro. Al seleccionar este botón se va abrirá la vista de juego, usted debería ver algo similar a la siguiente imagen:
